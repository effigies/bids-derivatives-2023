...
* [BEP 012](https://bids.neuroimaging.io/bep012) - Task MRI preprocessing derivatives
* [BEP 013](https://bids.neuroimaging.io/bep013) - Resting MRI preprocessing derivatives
...
: \- Introduction of "Common Derivatives", finding the points of agreement
...
```{.tsv filename="desc-AAL_dseg.tsv"}
index   name
1       Precentral_L
2       Precentral_R
3       Frontal_Sup_L
...
```{.yaml filename="desc-AAL_probseg.json"}
